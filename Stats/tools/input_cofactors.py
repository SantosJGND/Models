...
def get_pop_dict(reference,dir_sim= '',indfile= 'ind_assignments.txt'):
    ...
    for pop_chose in pop_avail:
        ...
        for each in timetable:  
            ...
            for perm in range(samp[2]):
                ...
                present_list= [pop_list[x] for x in range(len(smaller)) if smaller[x] == 1]
                
                new_pop= {
                    tag + '.s' + str(1):  present_list
                }
