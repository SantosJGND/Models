    ...
    for ref in pop_asso.keys():
        ...
        for pop in pop_asso[ref].keys():
            ...
            for sub in pop_asso[ref][pop].keys():
                ...
                count_data[d]= run_stats(ref,ref_pair,data,data_freqs= data_freqs,fasta_dict= fasta_dict_local,bsep=bsep,
                ...
                for pop2 in pop_asso[ref].keys():
                    ...
                    pair_stats= run_stats(ref,ref_pair,data,data_freqs= data_freqs,fasta_dict= fasta_dict_local,bsep=bsep,
