...
INFO_dict= {
    ...
    'chimp':{
        'dirs':{
            ...
            'sims': '/scratch/jgarc235/SLiM/chimp/FPop/',
            #'sims': '/scratch/jgarc235/SLiM/chimp/samp70k/'
            #'sims': '/home/jgarc235/SLiM/PM13_chimps/mutation_counter/data/pm13_4A_1m/'
        },
        'w_indfile': {
            'rd': 'chimp_ind_assignments.txt',
            'sims': 'ind_assignments.txt'
    ...
    'human':{
        'dirs':{
            ...
            'sims': '/scratch/jgarc235/SLiM/demos/data/gravel_FP/'
            #'sims': '/home/jgarc235/SLiM/demos/mutation_counter/data/gravel1_1MB/'
            },
        'w_indfile': {
