...
if __name__ == '__main__':
        ...
        #dir_data= main_dir + 'mutation_counter/data/rheLiu18_10M_v2/'
        dir_data= '/scratch/jgarc235/SLiM/rhe18/10M/'
        ...
        SLiM_dispenserv3(sim_store, cookID= cookID, slim_dir= slim_dir, batch_name= batch_name,
